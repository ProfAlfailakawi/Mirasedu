...
await api("POST", "/api/auth/login", { idNumber: AA, password: "A97852900" }, { deviceToken: "teacher-dev", jar: teacherJar });
await api("POST", "/api/auth/login", { idNumber: "ah.alfailakawi@paaet.edu.kw", password: "A97852900" }, { deviceToken: "admin-dev", jar: adminJar });
