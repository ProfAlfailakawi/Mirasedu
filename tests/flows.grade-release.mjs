...
const tlogin = await api("POST", "/api/auth/login", { idNumber: AA, password: "A97852900" }, { jar: tjar, deviceToken: tdev });
...
const tblogin = await api("POST", "/api/auth/login", { idNumber: BB, password: "A97852900" }, { jar: tbjar, deviceToken: tbdev });
